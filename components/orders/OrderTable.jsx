...
function DeliveryBadge({ status }) {
  const statusConfig = {
    pending: {
      color:
        "bg-yellow-900 text-yellow-300 dark:bg-yellow-900 dark:text-yellow-300",
      icon: Clock,
    },
    processing: {
      color: "bg-blue-900 text-blue-300 dark:bg-blue-900 dark:text-blue-300",
      icon: Clock,
    },
    shipped: {
      color:
    ...
    delivered: {
      color:
        "bg-green-800 text-green-400 dark:bg-green-800 dark:text-green-400",
      icon: CheckCircle,
    },
    cancelled: {
      color: "bg-red-900 text-red-300 dark:bg-red-900 dark:text-red-300",
      icon: XCircle,
    },
  };
